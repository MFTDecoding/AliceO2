...
/// @file   NoiseMapMergerSpec.h

#ifndef O2_MFT_NOISEMERGERSPEC
#define O2_MFT_NOISEMERGERSPEC
...
class NoiseMapMergerSpec : public Task
{
 public:
  NoiseMapMergerSpec(bool digits = false);
  ~NoiseMapMergerSpec() override = default;
